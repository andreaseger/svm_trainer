...
describe Evaluator::AccuracyOver(3) do
  let(:model) { DummyModel.new }
  let(:evaluator) { Evaluator::AccuracyOver(0.7).new(model) }
  ...
  it "should exclude to low entries" do
    evaluator.add(1,1,0.6).add(1,1,0.5).add(1,1,0.65).add(0,0,0.7).add(0,0,0.8)
